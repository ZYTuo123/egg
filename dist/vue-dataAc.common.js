...
var BASEOPTIONS = {
   ...
   * 以下内容为可配置信息，影响插件逻辑功能
   * */
  imageUrl: "http://127.0.0.1:7001/byIMG", //http://data.isjs.cn/lib/image/ac.png《建议》 图片上报地址（通过1*1px图片接收上报信息）
  postUrl: "http://127.0.0.1:7001/acData/push", // http://data.isjs.cn/logStash/push数据上报接口
